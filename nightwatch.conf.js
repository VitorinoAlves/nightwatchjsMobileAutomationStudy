  ...
  test_settings: {
    ...
    'app.android.emulator': {
      ...
      'desiredCapabilities': {
        ...
        'appium:options': {
          ...
          app: `${__dirname}/nightwatch/testingApp/app-release.apk`,
    ...
    'browserstack.android': {
      ...
      'desiredCapabilities': {
        ...
        'appium:options': {
          automationName: 'UiAutomator2',
          app: 'bs://6d62581d8517ad67aa3c8cfaea74dac97afa6b26',// custom-id of the uploaded app
          appPackage: 'com.qazandoapp',
          appActivity: 'com.qazandoapp.MainActivity',
          platformVersion: '9.0',
        ...
        appUploadPath: `${__dirname}/nightwatch/testingApp/app-release.apk` // if the app needs to be uploaded to BrowserStack from local system
      }
    },
